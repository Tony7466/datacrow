...
public class DcAttachmentPanelMenu extends JMenuBar {
    
    public DcAttachmentPanelMenu(AttachmentsPanel af) {
        build(af);
    }
        
    private void build(AttachmentsPanel af) {
