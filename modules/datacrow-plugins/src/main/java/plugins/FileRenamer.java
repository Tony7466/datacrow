...
public class FileRenamer extends Plugin {
    ...
    public void actionPerformed(ActionEvent e) {
        FileRenamerDialog dlg = GUI.getInstance().getFileRenamerDialog(getModuleIdx());
        dlg.setVisible(true);
    }    
    
    @Override
    public ImageIcon getIcon() {
        return IconLibrary._icoFileRenamer;
    }
    ...
    public String getLabel() {
        return DcResources.getText("lblFileRenamer", getModule().getObjectName());
    }
    
    @Override
    public String getHelpText() {
        return DcResources.getText("tpFileRenamer");
    }     
}
