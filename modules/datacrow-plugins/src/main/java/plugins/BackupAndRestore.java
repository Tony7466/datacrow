...
import org.datacrow.client.console.windows.BackupDialog;
...
public class BackupAndRestore extends Plugin {
    ...
    public ImageIcon getIcon() {
        return IconLibrary._icoBackup;
    }

    @Override
    public String getLabel() {
        return DcResources.getText("lblBackupAndRestore");
    }
    
    @Override
    public String getHelpText() {
        return DcResources.getText("tpBackupAndRestore");
    }      
}
