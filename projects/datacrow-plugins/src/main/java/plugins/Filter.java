...
public class Filter extends Plugin {
    ...
    public void actionPerformed(ActionEvent e) {
        FilterDialog fd = GUI.getInstance().getFilterDialog(getModuleIdx());
        fd.setVisible(true);
    }
    ...
    public String getLabel() {
        return DcResources.getText("lblFilter");
    }    
    
    @Override
    public String getHelpText() {
        return DcResources.getText("tpFilter");
    }       
}
