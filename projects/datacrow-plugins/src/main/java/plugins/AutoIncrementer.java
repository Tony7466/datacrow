...
import net.datacrow.client.console.windows.enhancers.AutoIncrementDialog;
...
public class AutoIncrementer extends Plugin {
    ...
    public void actionPerformed(ActionEvent e) {
        AutoIncrementDialog dialog = new AutoIncrementDialog();
    ...
    public ImageIcon getIcon() {
        return IconLibrary._icoRenumber;
    }

    @Override
    public String getLabel() {
        return DcResources.getText("lblAutoNumbering");
    }
    
    @Override
    public String getHelpText() {
        return DcResources.getText("tpAutoNumbering");
    }      
}
