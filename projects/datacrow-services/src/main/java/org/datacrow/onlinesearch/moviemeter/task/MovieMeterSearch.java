package org.datacrow.onlinesearch.moviemeter.task;
...
public class MovieMeterSearch extends SearchTask {
    ...
    private static final Logger logger = DcLogManager.getLogger(MovieMeterSearch.class.getName());
    ...
    protected DcObject getItem(Object key, boolean full) throws Exception {
        ...
        try {
            ...
            String result = HtmlUtils.getHtmlCleaned(new URL(url), StandardCharsets.UTF_8, 0);
