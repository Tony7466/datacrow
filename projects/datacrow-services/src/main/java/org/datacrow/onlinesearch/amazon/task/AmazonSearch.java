...
package org.datacrow.onlinesearch.amazon.task;
...
public abstract class AmazonSearch extends SearchTask {
	...
	private static Logger logger = DcLogManager.getLogger(AmazonSearch.class.getName());
	
    public static final int _KEYWORDSSEARCH = 0;
    public static final int _ASINSEARCH = 1;
    
    private final static String AWS_ACCESS_KEY_ID = "AKIAJHLT32F2JMMQEYNQ";
    private final static String AWS_SECRET_KEY = "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";
    ...
    protected DcObject getItem(URL url) throws Exception {
        //return getItem(HtmlUtils.getDocument(new URL(helper.sign(url)), StandardCharsets.UTF_8), true);
        return null;
    }
    ...
    protected Document getDocument(String asin) throws Exception {
        ...
        return null;//HtmlUtils.getDocument(getDetailURL(asin), StandardCharsets.UTF_8);
    }
    ...
    protected Collection<Object> getItemKeys() throws Exception {
    	...
    	/*try {
            Document document = HtmlUtils.getDocument(new URL(getSearchURL(getQuery())), StandardCharsets.ISO_8859_1);
