...
public class ImdbPersonSearch extends ImdbSearch {
    ...
    protected DcObject getItem(Object id, boolean full) throws Exception {
        ...
        DcObject person = personFinder.get(String.valueOf(id));
        return person;
    }
    
    @Override
    protected Collection<Object> getItemKeys() throws Exception {
        /*Document document = HtmlUtils.getDocument(new URL(getAddress() + "/find?s=nm&q=" + getQuery()), StandardCharsets.UTF_8);
