...
public class TableHeaderPopupMenu extends DcPopupMenu {

    public TableHeaderPopupMenu(int moduleIdx, int viewType, int viewIdx) {
        PluginHelper.add(this, "ViewSettings", moduleIdx, viewIdx, viewType);
