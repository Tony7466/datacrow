...
package net.datacrow.client.console.wizards.moduleimport;
...
import net.datacrow.client.console.windows.settings.SettingsPanel;
import net.datacrow.client.console.wizards.WizardException;
import net.datacrow.client.core.DcRepository;
import net.datacrow.client.core.resources.DcResources;
import net.datacrow.client.core.settings.Setting;
import net.datacrow.client.core.settings.SettingsGroup;
