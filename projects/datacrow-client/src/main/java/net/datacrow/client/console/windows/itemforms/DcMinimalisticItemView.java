...
import net.datacrow.client.console.components.lists.DcListModel;
...
import net.datacrow.client.console.menu.DcPropertyViewPopupMenu;
import net.datacrow.client.console.windows.CreateMultipleItemsDialog;
import net.datacrow.client.console.windows.DcFrame;
import net.datacrow.client.console.windows.MergePropertyItemsDialog;
