...
package net.datacrow.client.console.windows.onlinesearch;
...
import net.datacrow.core.utilities.cuecat.CueCatCode;
import net.datacrow.core.utilities.cuecat.CueCatDecoder;
