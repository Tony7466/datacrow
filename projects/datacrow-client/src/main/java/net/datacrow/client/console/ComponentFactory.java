...
package net.datacrow.client.console;
...
import net.datacrow.client.console.components.AwsKeyRequestDialog;
...
import net.datacrow.client.console.components.DcComboBox;
import net.datacrow.client.console.components.DcDateField;
import net.datacrow.client.console.components.DcDecimalField;
import net.datacrow.client.console.components.DcDirectoriesAsDrivesField;
import net.datacrow.client.console.components.DcDriveMappingField;
import net.datacrow.client.console.components.DcFileField;
import net.datacrow.client.console.components.DcFileLauncherField;
import net.datacrow.client.console.components.DcFilePatternField;
import net.datacrow.client.console.components.DcFilePatternTextField;
import net.datacrow.client.console.components.DcFileSizeField;
import net.datacrow.client.console.components.DcFontRenderingComboBox;
import net.datacrow.client.console.components.DcFontSelector;
import net.datacrow.client.console.components.DcHtmlEditorPane;
import net.datacrow.client.console.components.DcIconSelectField;
import net.datacrow.client.console.components.DcImageLabel;
import net.datacrow.client.console.components.DcLabel;
import net.datacrow.client.console.components.DcLoginNameField;
...
import net.datacrow.client.console.components.DcModuleSelector;
import net.datacrow.client.console.components.DcNumberField;
import net.datacrow.client.console.components.DcObjectComboBox;
import net.datacrow.client.console.components.DcPanel;
import net.datacrow.client.console.components.DcPasswordField;
import net.datacrow.client.console.components.DcPictureField;
import net.datacrow.client.console.components.DcProgramDefinitionsField;
import net.datacrow.client.console.components.DcRadioButton;
import net.datacrow.client.console.components.DcRatingComboBox;
import net.datacrow.client.console.components.DcReferenceField;
import net.datacrow.client.console.components.DcReferencesField;
import net.datacrow.client.console.components.DcShortTextField;
import net.datacrow.client.console.components.DcTabbedPane;
import net.datacrow.client.console.components.DcTagField;
import net.datacrow.client.console.components.DcTextPane;
import net.datacrow.client.console.components.DcTimeField;
import net.datacrow.client.console.components.DcTitledBorder;
import net.datacrow.client.console.components.DcToolBarButton;
import net.datacrow.client.console.components.DcTree;
import net.datacrow.client.console.components.DcUrlField;
import net.datacrow.client.console.components.IComponent;
import net.datacrow.client.console.components.renderers.AvailabilityComboBoxRenderer;
import net.datacrow.client.console.components.renderers.ComboBoxRenderer;
...
public final class ComponentFactory extends UIComponents {
    ...
    public static final void clean(final Component component) {
        ...
        if (component instanceof JComponent) {
            ...
            if (c instanceof net.datacrow.client.console.components.lists.DcList) 
                ((net.datacrow.client.console.components.lists.DcList) c).clear();
