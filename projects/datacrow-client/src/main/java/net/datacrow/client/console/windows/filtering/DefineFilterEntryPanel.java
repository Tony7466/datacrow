...
package net.datacrow.client.console.windows.filtering;
...
import net.datacrow.client.console.components.lists.DcFilterEntryList;
import net.datacrow.client.console.components.lists.elements.DcFilterEntryListElement;
