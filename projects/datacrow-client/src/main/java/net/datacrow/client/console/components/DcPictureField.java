...
package net.datacrow.client.console.components;
...
import net.datacrow.client.console.menu.DcPictureFieldMenu;
import net.datacrow.client.console.windows.BrowserDialog;
import net.datacrow.client.console.windows.OpenFromUrlDialog;
import net.datacrow.client.console.windows.PictureDialog;
import net.datacrow.client.util.Utilities;
import net.datacrow.client.util.filefilters.PictureFileFilter;
        ...
        if (picture != null) {
            ...
            try {
                if (file != null) {
                    ...
                    CoreUtilities.writeToFile(picture, new File(filename));
                }
            } catch (Exception e) {
