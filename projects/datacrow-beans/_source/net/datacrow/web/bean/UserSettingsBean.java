...
//    private HashMap<Integer, UserSettings> moduleSettings = new HashMap<Integer, UserSettings>();
...
//    private UserSettings getSettings(int moduleIdx) {
//        if (!moduleSettings.containsKey(Integer.valueOf(moduleIdx))) {
//            moduleSettings.put(Integer.valueOf(moduleIdx), new UserSettings());
//        }
//        
//        return moduleSettings.get(Integer.valueOf(moduleIdx));
//    }
