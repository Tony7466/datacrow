...
@Named 
@SessionScoped 
public class EditItemBreadCrumbBean extends DcBean {
    ...
    public void addItem(Item item) {
        ...
        if (!items.contains(mi)) {
            ...
            mi.setUpdate(":editItemDetail");
            mi.setOncomplete("PF('editItemDetail').show()");
            
            mi.setCommand("#{editItemBreadCrumbBean.selectItem}");
