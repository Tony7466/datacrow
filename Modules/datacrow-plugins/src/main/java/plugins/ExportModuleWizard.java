...
public class ExportModuleWizard extends Plugin {
    ...
    public void actionPerformed(ActionEvent e) {
        Wizard wizard = new org.datacrow.client.console.wizards.moduleexport.ExportModuleWizard();
        wizard.setVisible(true);
    }
    
    @Override
    public String getHelpText() {
        return DcResources.getText("tpExportModuleWizard");
    }
    ...
    public boolean isEnabled() {
        return DcModules.getCustomModules().size() > 0;
    }    
    
    @Override
    public String getLabel() {
        return DcResources.getText("lblModuleExportWizard");
    }
}
