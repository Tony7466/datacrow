...
public class ImportModuleWizard extends Plugin {
	...
	private static final long serialVersionUID = -3080825001587995866L;

	public ImportModuleWizard(DcObject dco, DcTemplate template, int viewIdx, int moduleIdx, int viewType) {
    ...
    public String getHelpText() {
        return DcResources.getText("tpImportModuleWizard");
    }
    ...
    public String getLabel() {
        return DcResources.getText("lblModuleImportWizard");
    }
}
