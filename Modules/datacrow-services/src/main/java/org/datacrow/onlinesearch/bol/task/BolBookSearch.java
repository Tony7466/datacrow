...
package org.datacrow.onlinesearch.bol.task;
...
import org.datacrow.onlinesearch.bol.BolClient;

public class BolBookSearch extends SearchTask {

    private static Logger logger = DcLogManager.getLogger(BolBookSearch.class.getName());
