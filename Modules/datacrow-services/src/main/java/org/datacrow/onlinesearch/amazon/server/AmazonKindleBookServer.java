...
public class AmazonKindleBookServer extends AmazonServer {
    
    private static final long serialVersionUID = 2116138084235874615L;

    private Collection<SearchMode> modes = new ArrayList<SearchMode>();
    
    public AmazonKindleBookServer() {
        super();
        modes.add(new KeywordSearchMode("KindleStore", "Keywords", Book._A_TITLE));
        modes.add(new IsbnSearchMode("KindleStore", Book._N_ISBN13));
    ...
    public String getName() {
        return super.getName() + " Kindle Store";
    }
