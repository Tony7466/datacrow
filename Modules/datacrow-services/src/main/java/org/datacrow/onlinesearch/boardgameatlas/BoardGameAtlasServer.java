...
public class BoardGameAtlasServer implements IServer {
    ...
    public String getUrl() {
        return "https://boardgameatlas.com/";
    }
    ...
    public SearchTask getSearchTask(
        ...
        BoardGameAtlasSearch task = new BoardGameAtlasSearch(listener, this, region, mode, query, additionalFilters);
