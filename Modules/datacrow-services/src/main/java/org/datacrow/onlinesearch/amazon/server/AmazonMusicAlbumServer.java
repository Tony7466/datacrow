...
import org.datacrow.onlinesearch.amazon.task.AmazonMusicSearch;

public class AmazonMusicAlbumServer extends AmazonServer {

    private static final long serialVersionUID = -8416897314169629378L;
    ...
    public SearchTask getSearchTask(IOnlineSearchClient listener, SearchMode mode, Region region, String query, DcObject client) {
        AmazonMusicSearch task = new AmazonMusicSearch(listener, this, region, mode, query);
